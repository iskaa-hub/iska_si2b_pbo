...
class Warung2 extends Warung{
  ...
  public function __construct($namaBarang, $harga, $expired){
  ...
  //overriding
  public function informasi(){
      echo "Barang2: $this->namaBarang, Harga: Rp. $this->harga, Kadaluarsa: $this->expired";
  }
...
$barang3 = new Warung3();
echo "<br> Harga Indomie: Rp. ".$barang3->total(4000) . "<br>";
